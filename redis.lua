...
---------------------------------------------
|-------------------------------------------|
|This Source Was Developed By (Basha) @S666F.|
|  This Is The Source Channel @D666N .   |
|               - CukurSource -                 |
---------------------------------------------
]]..'\27[m')
...
https.request('https://api.telegram.org/bot'..TokenBot..'/sendMessage?chat_id='..Bilal..'&text='..URL.escape("⌁︙لقد توقف البوت بسبب انهاير الريدز في السيرفر افتح الترمنال وارسل ↫ ⤈\n`service redis start` ")..'&parse_mode=Markdown')
end
os.exit()
end
end
